...
syn match logIPV6       '\v<(\x{1,4}:){7,7}\x{1,4}>'
syn match logIPV6       '\v<(\x{1,4}:){1,7}:>'
syn match logIPV6       '\v<(\x{1,4}:){1,6}:\x{1,4}>'
syn match logIPV6       '\v<(\x{1,4}:){1,5}(:\x{1,4}){1,2}>'
syn match logIPV6       '\v<(\x{1,4}:){1,4}(:\x{1,4}){1,3}>'
syn match logIPV6       '\v<(\x{1,4}:){1,3}(:\x{1,4}){1,4}>'
syn match logIPV6       '\v<(\x{1,4}:){1,2}(:\x{1,4}){1,5}>'
syn match logIPV6       '\v<\x{1,4}:((:\x{1,4}){1,6})>'
syn match logIPV6       '\v<:((:\x{1,4}){1,7}|:)>'
